...
swr_igBeginTable :: proc(str_id: string, columns: i32, flags: Table_Flags, outer_size: Vec2, inner_width: f32) -> bool {
	str0 := strings.clone_to_cstring(str_id, context.temp_allocator);
	return igBeginTable(str0, columns, flags, outer_size, inner_width);
}
...
// AUTO_GENERATED for 'igDebugLog'
swr_igDebugLog :: proc(fmt_: string, args: ..any) {
	str0 := strings.clone_to_cstring(fmt_, context.temp_allocator);
	igDebugLog(str0, args);
}
...
swr_igColumns :: proc(count: i32, id: string, borders: bool) {
	str1 := strings.clone_to_cstring(id, context.temp_allocator);
	igColumns(count, str1, borders);
}
...
// AUTO_GENERATED for 'igImageButton'
swr_igImageButton :: proc(str_id: string, user_texture_id: Texture_ID, image_size: Vec2, uv0: Vec2, uv1: Vec2, bg_col: Vec4, tint_col: Vec4) -> bool {
	str0 := strings.clone_to_cstring(str_id, context.temp_allocator);
	return igImageButton(str0, user_texture_id, image_size, uv0, uv1, bg_col, tint_col);
}
...
// AUTO_GENERATED for 'igCombo_FnStrPtr'
swr_igCombo_FnStrPtr :: proc(label: string, current_item: ^i32, getter: ^^cstring, user_data: rawptr, items_count: i32, popup_max_height_in_items: i32) -> bool {
	str0 := strings.clone_to_cstring(label, context.temp_allocator);
	return igCombo_FnStrPtr(str0, current_item, getter, user_data, items_count, popup_max_height_in_items);
}
...
// AUTO_GENERATED for 'igTextLinkOpenURL'
swr_igTextLinkOpenURL :: proc(label: string, url: string) {
	str0 := strings.clone_to_cstring(label, context.temp_allocator);
	str1 := strings.clone_to_cstring(url, context.temp_allocator);
	igTextLinkOpenURL(str0, str1);
}
...
// AUTO_GENERATED for 'igListBox_FnStrPtr'
swr_igListBox_FnStrPtr :: proc(label: string, current_item: ^i32, getter: ^^cstring, user_data: rawptr, items_count: i32, height_in_items: i32) -> bool {
	str0 := strings.clone_to_cstring(label, context.temp_allocator);
	return igListBox_FnStrPtr(str0, current_item, getter, user_data, items_count, height_in_items);
}
...
// AUTO_GENERATED for 'igSeparatorText'
swr_igSeparatorText :: proc(label: string) {
	str0 := strings.clone_to_cstring(label, context.temp_allocator);
	igSeparatorText(str0);
}
...
// AUTO_GENERATED for 'igTextLink'
swr_igTextLink :: proc(label: string) -> bool {
	str0 := strings.clone_to_cstring(label, context.temp_allocator);
	return igTextLink(str0);
}
...
// AUTO_GENERATED for 'igSetItemTooltip'
swr_igSetItemTooltip :: proc(fmt_: string, args: ..any) {
	str0 := strings.clone_to_cstring(fmt_, context.temp_allocator);
	igSetItemTooltip(str0, args);
}


// AUTO_GENERATED for 'igBeginChild_Str'
swr_igBeginChild_Str :: proc(str_id: string, size: Vec2, child_flags: Child_Flags, window_flags: Window_Flags) -> bool {
	str0 := strings.clone_to_cstring(str_id, context.temp_allocator);
	return igBeginChild_Str(str0, size, child_flags, window_flags);
}
